...
const PageOS = () => {
  ...
  return (
    <main className="w-full h-screen flex relative gap-16 max-h-[calc(100vh-10rem)] max-lg:flex-col px-4">
      <div className="flex w-full h-full   lg:max-w-80 max-lg:w-full max-lg:h-min  flex-col gap-6 max-lg:justify-center max-lg:items-center max-lg:text-center ">
        ...
        <div className="flex flex-col gap-6 w-full max-lg:flex-row max-lg:justify-center max-w-sm ">
          <Button
            size="full"
      ...
      <ScrollArea className="flex w-full h-full flex-1  md:max-h-[calc(100vh-10rem)] "></ScrollArea>
    </main>
  );
};
